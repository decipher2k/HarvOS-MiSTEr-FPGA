...
// ---- Added by patch: SCAPS bit indices and misc opcodes ----
localparam int SCAPS_WX_ENFORCED_BIT   = 7;
localparam int SCAPS_NX_D_BIT          = 6;
localparam int SCAPS_PAGING_ALWAYS_BIT = 5;
localparam int SCAPS_DMA_FW_BIT        = 4;
localparam int SCAPS_SV32_BIT          = 3;
localparam int SCAPS_HARVARD_BIT       = 2;
localparam int SCAPS_FENCEI_BIT        = 1;

// Standard RISC-V opcode for fence/fence.i group ("misc-mem")
localparam logic [6:0] OPC_MISC_MEM = 7'b0001111;
localparam logic [6:0] OPC_FENCE    = OPC_MISC_MEM;

// Load/store size encoding used by core
localparam logic [1:0] LS_B = 2'd0;
localparam logic [1:0] LS_H = 2'd1;
localparam logic [1:0] LS_W = 2'd2;
