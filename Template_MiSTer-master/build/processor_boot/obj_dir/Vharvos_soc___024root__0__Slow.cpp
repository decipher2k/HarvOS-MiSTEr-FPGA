...
VL_ATTR_COLD void Vharvos_soc___024root___eval_initial__TOP(Vharvos_soc___024root* vlSelf) {
    ...
    while (VL_GTS_III(32, 0x00000100U, harvos_soc__DOT__init_i)) {
        vlSelfRef.harvos_soc__DOT__imem[(0x000000ffU 
                                         & harvos_soc__DOT__init_i)] = 0x00000013U;
        harvos_soc__DOT__init_i = ((IData)(1U) + harvos_soc__DOT__init_i);
    }
    harvos_soc__DOT__init_i = 0U;
    while (VL_GTS_III(32, 0x00000400U, harvos_soc__DOT__init_i)) {
        vlSelfRef.harvos_soc__DOT__dmem[(0x000003ffU 
                                         & harvos_soc__DOT__init_i)] = 0U;
        harvos_soc__DOT__init_i = ((IData)(1U) + harvos_soc__DOT__init_i);
    }
    ...
    if (VL_UNLIKELY((harvos_soc__DOT__external_imem_init))) {
        VL_READMEM_N(true, 32, 256, 0, vlSelfRef.harvos_soc__DOT__imem_init_file
    ...
    if (VL_UNLIKELY((harvos_soc__DOT____VlemExpr_103))) {
        VL_READMEM_N(true, 32, 1024, 0, vlSelfRef.harvos_soc__DOT__dmem_init_file
